...
insert into Employee(id,name,gender,age) values(1,'Raveena','female',22);
insert into Employee(id,name,gender,age) values(2,'Raj','other',31);
insert into Employee(id,name,gender,age) values(3,'John','male',24);
